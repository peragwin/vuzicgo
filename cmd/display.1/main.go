...
const (
	...
	textureMode = gl.NEAREST
)

var (
	width  = flag.Int("width", 400, "width of window")
	height = flag.Int("height", 1600, "height of window")
...
func main() {
	...
	rndr := newRenderer(&params{gridWidth, gridHeight, gridDepth}, f)
